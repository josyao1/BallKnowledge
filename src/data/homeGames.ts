...
export const GAMES: GameCard[] = [
  ...
  { id: 'guess-player',   abbr: 'GP', name: 'Guess the Player',   tagline: 'Career arc, name scramble, or face reveal',         color: '#3b82f6', hasSolo: true,                  image: '/images/name-scramble.svg' },
