...
describe('getTeamLogoUrl', () => {
  describe('NBA logos', () => {
    ...
    it('uses ESPN-specific slug overrides', () => {
      expect(getTeamLogoUrl('nba', 'GSW')).toBe('https://a.espncdn.com/i/teamlogos/nba/500/gs.png');
      expect(getTeamLogoUrl('nba', 'SAS')).toBe('https://a.espncdn.com/i/teamlogos/nba/500/sa.png');
      expect(getTeamLogoUrl('nba', 'NYK')).toBe('https://a.espncdn.com/i/teamlogos/nba/500/ny.png');
      expect(getTeamLogoUrl('nba', 'NOP')).toBe('https://a.espncdn.com/i/teamlogos/nba/500/no.png');
    ...
    it('resolves historical + ESPN slug together', () => {
      // SAN → SAS → sa
      expect(getTeamLogoUrl('nba', 'SAN')).toBe('https://a.espncdn.com/i/teamlogos/nba/500/sa.png');
      // NOH → NOP → no
      expect(getTeamLogoUrl('nba', 'NOH')).toBe('https://a.espncdn.com/i/teamlogos/nba/500/no.png');
    });
  ...
  describe('NFL logos', () => {
    it('returns correct URL for standard NFL abbreviation', () => {
      expect(getTeamLogoUrl('nfl', 'KC')).toBe('https://a.espncdn.com/i/teamlogos/nfl/500/kc.png');
    });
