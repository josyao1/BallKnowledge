...
const MODES: { id: GameId; label: string; abbr: string; desc: string; color: string }[] = [
  {
    ...
    label: 'Career Arc',
    abbr: 'CA',
    desc: "Trace a player's career year by year",
    color: '#22c55e',
  },
  {
    id: 'scramble',
    label: 'Name Scramble',
    abbr: 'NS',
    desc: 'Unscramble athlete names vs the clock',
    color: '#3b82f6',
  },
  {
    id: 'face-reveal',
    label: 'Face Reveal',
    abbr: 'FR',
    desc: 'Identify a player from their headshot',
    color: '#06b6d4',
  },
];
        ...
        {MODES.map((m) => (
          ...
          >
            ...
            <div className="text-left flex-1 min-w-0">
              <div className="capcrunch-title text-sm leading-tight" style={{ color: m.color }}>
                {m.label}
              </div>
