          ...
          <div className="p-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                {SCRAMBLE_TO_YEARS.map(y => <option key={y} value={y}>{y}+</option>)}
              </select>
            </div>
                  ...
                  {MPG_OPTIONS.map(opt => (
                    <button
                      ...
                      className={`flex-1 py-2 capcrunch-kicker text-[10px] border transition-all ${
                        minMpg === opt.value ? 'text-white border-transparent' : 'border-white/10 text-white/40 hover:border-white/25 hover:text-white/60'
                      }`}
                ...
                <div className="flex gap-2">
                  {YARD_OPTIONS.map(opt => (
                    <button
                      ...
                      className={`flex-1 py-2 capcrunch-kicker text-[10px] border transition-all ${
                        minYards === opt.value ? 'text-white border-transparent' : 'border-white/10 text-white/40 hover:border-white/25 hover:text-white/60'
                      }`}
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                onClick={() => navigate('/scramble', { state: { careerTo: activeYear || undefined, minMpg: minMpg || undefined, minYards: minYards || undefined, includeDefense: sport === 'nfl' ? includeDefense : undefined } })}
