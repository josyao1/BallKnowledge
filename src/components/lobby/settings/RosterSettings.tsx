    ...
    <div className="space-y-2.5">
      ...
      {randomSport ? (
        ...
        <>
          <Row label="Pick">
            <Chips>
              <Chip active={gameMode === 'random'} onClick={() => onGameModeChange('random')}>
                Random
              </Chip>
              <Chip active={gameMode === 'manual'} onClick={() => onGameModeChange('manual')}>
                Manual
              </Chip>
            </Chips>
          </Row>
          ...
          {gameMode === 'random' && (
            <Row label="Scope">
              <Chips>
                <Chip
                  active={selectionScope === 'team'}
                  onClick={() => onSelectionScopeChange('team')}
                >
                  Team
                </Chip>
                <Chip
                  active={selectionScope === 'division'}
                  onClick={() => onSelectionScopeChange('division')}
                >
                  Division
                </Chip>
              </Chips>
