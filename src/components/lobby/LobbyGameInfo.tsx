          ...
          <div className="min-w-0">
            {lobby.game_type === 'scramble' ? (
              ...
              <>
                ...
                <div
                  className={`capcrunch-kicker text-[9px] ${cs?.hardMode ? 'text-red-400' : 'text-white/40'}`}
                >
              ...
              <>
                ...
                <div className="capcrunch-kicker text-[9px] text-white/40">
                  ...
                  {cs?.top_ten_sport === 'nba' || cs?.top_ten_sport === 'nfl'
                    ...
                    : ''}
                  {cs?.max_strikes
                    ? ` · ${cs.max_strikes} strike${cs.max_strikes > 1 ? 's' : ''}`
                    : ''}
                </div>
              </>
            ) : (
            ...
            {showTimer && (
              <div className="text-left sm:text-right">
                ...
                <div className="capcrunch-title text-2xl text-white">
                  {Math.floor(lobby.timer_duration / 60)}:
                  {String(lobby.timer_duration % 60).padStart(2, '0')}
                </div>
              </div>
            )}
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
            {[...players]
              ...
              .map((player) => (
                ...
                >
                  <span className="capcrunch-kicker text-sm text-white/80 truncate">
                    {player.player_name}
                  </span>
