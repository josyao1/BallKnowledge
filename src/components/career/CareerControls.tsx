    ...
    <div className="flex flex-col gap-3">
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-black/40 border border-white/10 px-4 py-3 capcrunch-kicker text-sm text-white placeholder-white/30 focus:outline-none focus:border-white/25"
          autoFocus
        />
        <button
          onClick={onGuess}
          disabled={!guessInput.trim()}
          className="px-6 py-3 capcrunch-kicker text-sm text-white disabled:opacity-50 transition-all"
      ...
      <div className="flex flex-wrap gap-2 justify-center">
        <button
          ...
          className="px-4 py-2 capcrunch-kicker text-xs bg-black/40 border border-white/10 text-white/60 hover:border-white/25 disabled:opacity-30 transition-all"
        >
        ...
        <button
          onClick={onGiveUp}
          className="px-4 py-2 capcrunch-kicker text-xs bg-black/40 border border-red-900/50 text-red-400 hover:border-red-700 transition-all"
        >
          Give Up
        </button>
      </div>
