  ...
  return (
    <div className="min-h-screen home-chalkboard text-white flex flex-col p-4 md:p-6">
      ...
      <header className="text-center mb-8 mt-4">
        ...
        <h1 className="capcrunch-title text-4xl md:text-5xl" style={{ color: COLOR }}>Face Reveal</h1>
      ...
      {matchWinner && (
        ...
        >
          ...
          >
            ...
            <div className="capcrunch-kicker text-sm text-[#888] mt-1">{matchWinner.points ?? 0} pts</div>
          </div>
        </motion.div>
      )}
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className={`capcrunch-title text-lg w-8 text-center ${rank === 0 ? 'text-[#d4af37]' : 'text-[#555]'}`}>
                        #{rank + 1}
                      </span>
                    ...
                    <span className="capcrunch-title text-xl" style={{ color: COLOR }}>{pts}</span>
                  </div>
                  ...
                  <div key={round.round} className="border border-white/10 overflow-hidden">
                    ...
                    <div className="px-3 py-2 bg-black/40 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="capcrunch-title text-sm text-white/80">{round.playerName}</div>
                      </div>
                    </div>
                    {/* Player rows */}
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <span className={`capcrunch-kicker text-xs ${pts > 0 ? 'text-white/80' : 'text-white/30'}`}>
                                {player.player_name}
                            ...
                            <span className={`capcrunch-title text-base ${pts > 0 ? 'text-[#d4af37]' : 'text-[#444]'}`}>
                              {pts > 0 ? `+${pts}` : '—'}
                            </span>
                          </div>
                        );
