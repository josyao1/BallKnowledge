  ...
  return (
    <div className="min-h-screen text-white" style={{ background: '#080808' }}>
      ...
      <div className="max-w-5xl mx-auto px-3 py-4 space-y-4">
        ...
        {/* Score card */}
        <div
          className="relative overflow-hidden rounded-2xl p-6 flex flex-col items-center gap-2"
          style={{
            background: `linear-gradient(135deg, ${awayColor}18 0%, #141414 40%, #141414 60%, ${homeColor}18 100%)`,
            border: '1px solid rgba(245,158,11,0.2)',
          }}
        >
          <div className="sports-font text-[10px] text-[#555] tracking-[0.4em] uppercase">Final Score</div>
          <div className="retro-title text-7xl text-[#f59e0b] tabular-nums leading-none">
